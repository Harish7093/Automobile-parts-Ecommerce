...
function middle_navbar(hide = false) {
  ...
  const isMerchant = userObject.isMerchant || false;
  
  let data = null;
  let sidebar_login = null;
  if (logged == true || logged === "true") {
    data = `<div class="myaccount">
    <a href="/profile.html" class="myaccount-btn">My Account</a>
    ${isMerchant ? `<a href="/addProduct.html" class="sell-btn">Sell</a>` : ''}
  </div>`;
  ...
  return ` <!---------------------------------------------->
    ...
    <div id="menu-btn" class="menu">
        ...
        <i id="menu-icon" class="fa-solid fa-bars fa-xl" style="color: rgb(243,183,11);"></i>
          ...
          <div id="sidebar" class="sidebar hide_sidebar">
              <div class="middle_first">
                  <h1 id="logo_cl" class="logo-text">Auto-Tech Hub</h1>
                  <div id="side_close">
      ...
      <div class="middle_first">
          <h1 id="logo_click" class="logo-text">Auto-Tech Hub</h1>
      </div>
     ${middle}
      <div class="middle_third">
          ...
          <a class="favorite" href="/profile.html#wishlist" onclick="showWishlist()">
              <i class="fa-solid fa-heart fa-lg" style="color: rgb(0, 0, 0, 0.4);">
                  <div id="item_count_wishlist" class="item_count" style="display:none;">
                      0
                  </div>
              </i>
          </a>
...
function cartItemUpdate(selector = "#item_count_cart") {
    const userObject = JSON.parse(localStorage.getItem("userObject")) || { cart: [] };
    const cartCount = userObject.cart?.length || 0;
...
function wishlistItemUpdate() {
    const userObject = JSON.parse(localStorage.getItem("userObject")) || { wishlist: [] };
    const wishlistCount = userObject.wishlist?.length || 0;
    const wishlistCountElement = document.querySelector("#item_count_wishlist");
...
window.showWishlist = function() {
    ...
    if (section) {
        ...
        document.querySelector('.profile-nav li[onclick="showSection(\'wishlist\')"]').classList.add('active');
    }
};
